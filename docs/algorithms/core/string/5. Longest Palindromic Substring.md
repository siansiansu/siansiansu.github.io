...
:::spoiler Hint - Expand From Centers
```cpp=
class Solution {
public:
    string longestPalindrome(string s)
...
:::spoiler Solution - Expand From Centers
```cpp=
class Solution {
public:
    string longestPalindrome(string s)
...
:::spoiler Hint - Manacher's Algorithm
```cpp=
class Solution {
public:
    string longestPalindrome(string s)
...
:::spoiler Solution - Manacher's Algorithm
```cpp=
class Solution {
public:
    string longestPalindrome(string s)
